...
import 'package:apotek_asakami_app/Screen/confirmation.dart';
import 'package:apotek_asakami_app/Screen/courier/main_courier.dart';
  ...
  Future<void> _login() async {
    try {
      ...
      if (user != null) {
        ...
        } else if (userDoc.exists && userDoc['role'] == 'courier') {
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(
              builder: (context) => const CourierPage(),
            ),
          );
        } else {
